...
public class Verify extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationCompleted(PhoneAuthCredential credential) {
                ...
                Log.d(TAG, "Verification complete" + credential);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            // [START_EXCLUDE]
                            Toast.makeText(getApplicationContext(), "sign In Sucess", Toast.LENGTH_LONG).show();
                            // [END_EXCLUDE]
                        } else {
        ...
        if (user != null) {
            ...
            mUserDB.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                private void writeNewUser(String uid) {
                    ...
                    User user1 = new User();
                    user1.setUsername("");
                    user1.setUid(FirebaseAuth.getInstance().getCurrentUser().getUid());
                    mUserDB.child(getString(R.string.users_node)).child(uid).setValue(user1);
    ...
    private boolean validatePhoneNumber() {
        ...
        if (TextUtils.isEmpty(phoneNumber)) {
            mPhoneNumberField.setError("phone number Required");
            return false;
        }
